        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://yellow-marysa-79.tiiny.site/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-cyber-accent transition-colors">Resume</a>
              </li>
              <li>
